...
4.  Clean and build the Generating_Constant_Analog_Signal.X project. Right click on the **Generating_Constant_Analog_Signal.X** project and select **Clean and Build**.
